...
const getCodecovUrl = (repo, token) => `https://codecov.io/api/gh/${repo}?access_token=${token}`;
const getGeckoboardDatasetUrl = (repo) => `https://api.geckoboard.com/datasets/${(0, lodash_1.camelCase)(repo).toLowerCase()}.by_day`;
const getGeckoboardDatasetDataUrl = (repo) => `${getGeckoboardDatasetUrl(repo)}/data`;
const createGeckoboardDataset = () => ({
    fields: {
        coverage: {
            type: 'number',
            name: 'Coverage',
...
const createGeckoboardDatasetData = (coverage) => ({
    data: [
        {
...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const codecovResponse = yield axios_1.default.get(codecovUrl);
        const currentCoverage = (_c = (_b = (_a = codecovResponse.data) === null || _a === void 0 ? void 0 : _a.commit) === null || _b === void 0 ? void 0 : _b.totals) === null || _c === void 0 ? void 0 : _c.c;
        if (!currentCoverage) {
            throw new Error('Failed to get current from Codecov');
        }
        yield axios_1.default.put(getGeckoboardDatasetUrl(githubRepo), createGeckoboardDataset(), {
            auth: {
                username: geckoboardToken,
                password: ''
            }
        });
        yield axios_1.default.post(getGeckoboardDatasetDataUrl(githubRepo), createGeckoboardDatasetData(currentCoverage), {
            auth: {
                username: geckoboardToken,
                password: ''
            }
